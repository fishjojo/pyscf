...
extern void add_and_permute(double *out, double *w, double *v, int n, double fac);
extern void get_wv(double *w, double *v, double *cache,
                       ...
                       )
{
    ...
    #pragma omp parallel
    {
        ...
        int a, b, c;
        size_t k;
        double *cache1 = malloc(sizeof(double) * (nocc*nocc*nocc*6));
